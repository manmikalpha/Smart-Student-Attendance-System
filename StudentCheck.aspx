<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentCheck.aspx.cs" Inherits="RegLog.StudentCheck" %>
...
<body>
    <nav class="navbar sticky-top navbar-expand-md bg-dark navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link active px-3 pl-lg-5" href="StudentCheck.aspx">Subject Info</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link px-3 " href="StudentMain.aspx">Attendance</a>
                </li>
                <li class="nav-item">
    ...
    <div class="card mx-auto col-8 col-md-6 col-lg-4 col-xl-3"> 
        ...
        <br />
            <table id="checktable" class="table table-bordered table-active table-striped" >
