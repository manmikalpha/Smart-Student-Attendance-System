<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TeacherLogin.aspx.cs" Inherits="RegLog.TeacherLogin" %>
...
<body>
     <nav class="navbar sticky-top navbar-expand-md bg-dark navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link active px-3 pl-lg-5" href="TeacherLogin.aspx">Teacher Login</a>
                </li>
                <li class="nav-item">
    ...
    <div class="card mx-auto col-8 col-md-6 col-lg-4 col-xl-3"> 
        <h5 class="card-header ">Teacher Login <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
...
&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <asp:TextBox ID="iuname" runat="server" OnTextChanged="iuname_TextChanged" ></asp:TextBox> <label>Username</label>
            </div>
            &nbsp;<div class="input-group">
